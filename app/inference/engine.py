...
#         BoT-SORT
#           ↓
#         confidence + temporal-consistency class voting
#           ↓
#         line crossing
#           ↓
#         unique track count
...
#             0.08,
#             (
#                 "Starting TensorRT YOLO26m FP16 + "
#                 "BoT-SORT "
...
#             progress_callback,
#             0.75,
#             "Building confidence + temporal-consistency class voting...",
#         )
...
#             progress_callback,
#             0.81,
#             "Counting unique track crossings...",
#         )
...
#             progress_callback,
#             0.88,
#             "Calculating track and count confidence...",
#         )
...
#             (metadata.frame_count + self.config.detection.vid_stride - 1)
#             // self.config.detection.vid_stride
#         )

#         inference_source_fps = (
#             processed_frame_estimate / phase1_elapsed
#             if phase1_elapsed > 0
#             else None
#         )
...
#             "processing_fps_original_video": processing_fps,
...
class TrafficCountingEngine:
    ...
    def __init__(
        ...
        # Inisialisasi model di awal, satu kali saja.
        self.tracker = YOLOBoTSORTTracker(
            model_name=self.config.detection.model_name,
            tracker=self.config.detection.tracker,
            imgsz=self.config.detection.imgsz,
